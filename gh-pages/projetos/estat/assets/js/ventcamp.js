    ...
    initGoogleMap: function() {
        ...
        if ( $('.map').length ) {
            $('.map').each(function () {
                ...
                var mapData = { mapZoom: 17, relativeOffset: true, offsetX: 10, offsetY: 10, markerAddress: "Av Beira Mar, 2200, Meireles, Fortaleza, CE" };
    ...
    countdownInit: function () {
        if ( $('.countdown').length ) {
            if ( typeof $.fn.countdown == 'function' ) {
                var futureDate = new Date(2017, 9, 6, 7, 0, 0);
                $countdown = $('.countdown');
